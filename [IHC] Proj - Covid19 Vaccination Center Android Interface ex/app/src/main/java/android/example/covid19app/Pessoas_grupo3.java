...
public class Pessoas_grupo3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mylist.add("Jacinto Vieira");
        mylist.add("Tomas Ribeiro");
        mylist.add("Paulo Bento");
        mylist.add("Filipe Linz");
        mylist.add("Paulo Sousa");
        mylist.add("Catarina Madureira");
        mylist.add("Manuel Fernandes");
        mylist.add("José Alberto");
        mylist.add("Zeca do Pernil");
        mylist.add("Joana Torgal");
        ...
        adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, mylist){
            ...
            public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
                ...
                if(((TextView) view ).getText().toString().equals("Joana Torgal")){
                    view.setBackgroundColor(Color.YELLOW);

                }

                if(((TextView) view ).getText().toString().equals("Jacinto Vieira")){
